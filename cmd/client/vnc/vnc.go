...
var clientVncCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return utils.StartLocalProxyAndOpenClient(cmd, args, "vnc", hostname, localListenerPort, useWsProxy)
	},
}
...
func AddCommandsTo(client *cobra.Command) {
	...
	clientVncCmd.Flags().BoolVarP(&useWsProxy, "wsproxy", "w", false, "Use websocket proxy")
