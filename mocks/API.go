...
func (_m *API) AttachPolicies(ctx context.Context, socketID string, policyUUIDs []string) ([]string, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for AttachPolicies")
	}
...
func (_m *API) CreateSession(session models.Session) (*models.SessionCreateResult, error) {
	...
	var r0 *models.SessionCreateResult
	var r1 error
	if rf, ok := ret.Get(0).(func(models.Session) (*models.SessionCreateResult, error)); ok {
		return rf(session)
	}
	if rf, ok := ret.Get(0).(func(models.Session) *models.SessionCreateResult); ok {
		r0 = rf(session)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.SessionCreateResult)
		}
	}
...
// API_CreateSession_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateSession'
type API_CreateSession_Call struct {
	*mock.Call
}

// CreateSession is a helper method to define mock.On call
//   - session models.Session
func (_e *API_Expecter) CreateSession(session interface{}) *API_CreateSession_Call {
	return &API_CreateSession_Call{Call: _e.mock.On("CreateSession", session)}
}

func (_c *API_CreateSession_Call) Run(run func(session models.Session)) *API_CreateSession_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *API_CreateSession_Call) Return(_a0 *models.SessionCreateResult, _a1 error) *API_CreateSession_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *API_CreateSession_Call) RunAndReturn(run func(models.Session) (*models.SessionCreateResult, error)) *API_CreateSession_Call {
	_c.Call.Return(run)
	return _c
}

// CreateSessionEvent provides a mock function with given fields: event
func (_m *API) CreateSessionEvent(event models.SessionEvent) error {
	ret := _m.Called(event)

	if len(ret) == 0 {
		panic("no return value specified for CreateSessionEvent")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(models.SessionEvent) error); ok {
		r0 = rf(event)
	} else {
		r0 = ret.Error(0)
	}
...
// API_CreateSessionEvent_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateSessionEvent'
type API_CreateSessionEvent_Call struct {
	*mock.Call
}

// CreateSessionEvent is a helper method to define mock.On call
//   - event models.SessionEvent
func (_e *API_Expecter) CreateSessionEvent(event interface{}) *API_CreateSessionEvent_Call {
	return &API_CreateSessionEvent_Call{Call: _e.mock.On("CreateSessionEvent", event)}
}

func (_c *API_CreateSessionEvent_Call) Run(run func(event models.SessionEvent)) *API_CreateSessionEvent_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(models.SessionEvent))
	})
	return _c
}

func (_c *API_CreateSessionEvent_Call) Return(_a0 error) *API_CreateSessionEvent_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *API_CreateSessionEvent_Call) RunAndReturn(run func(models.SessionEvent) error) *API_CreateSessionEvent_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *API) CreateTunnel(ctx context.Context, socketID string) (*models.Tunnel, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for CreateTunnel")
	}
...
func (_m *API) DetachPolicies(ctx context.Context, socketID string, policyUUIDs []string) ([]string, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for DetachPolicies")
	}
...
func (_m *API) EndSession(session models.Session) error {
	ret := _m.Called(session)
...
// API_EndSession_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'EndSession'
type API_EndSession_Call struct {
	*mock.Call
}

// EndSession is a helper method to define mock.On call
//   - session models.Session
func (_e *API_Expecter) EndSession(session interface{}) *API_EndSession_Call {
	return &API_EndSession_Call{Call: _e.mock.On("EndSession", session)}
}

func (_c *API_EndSession_Call) Run(run func(session models.Session)) *API_EndSession_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(models.Session))
	})
	return _c
...
func (_c *API_EndSession_Call) Return(_a0 error) *API_EndSession_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *API_EndSession_Call) RunAndReturn(run func(models.Session) error) *API_EndSession_Call {
	_c.Call.Return(run)
	return _c
}

// Evaluate provides a mock function with given fields: ctx, socket, clientIP, userEmail, sessionKey
func (_m *API) Evaluate(ctx context.Context, socket *models.Socket, clientIP string, userEmail string, sessionKey string) ([]any, map[string][]string, error) {
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, *models.Socket, string, string, string) ([]any, map[string][]string, error)); ok {
		return rf(ctx, socket, clientIP, userEmail, sessionKey)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *models.Socket, string, string, string) []any); ok {
...
func (_c *API_Evaluate_Call) Return(allowedActions []any, info map[string][]string, err error) *API_Evaluate_Call {
	_c.Call.Return(allowedActions, info, err)
	return _c
}

func (_c *API_Evaluate_Call) RunAndReturn(run func(context.Context, *models.Socket, string, string, string) ([]any, map[string][]string, error)) *API_Evaluate_Call {
	_c.Call.Return(run)
	return _c
}

// EvaluatePeer provides a mock function with given fields: ctx, socket, clientIP, publicKey
func (_m *API) EvaluatePeer(ctx context.Context, socket *models.Socket, clientIP string, publicKey string) (string, string, []any, map[string][]string, error) {
	ret := _m.Called(ctx, socket, clientIP, publicKey)

	if len(ret) == 0 {
		panic("no return value specified for EvaluatePeer")
	}
	...
	var r4 error
	if rf, ok := ret.Get(0).(func(context.Context, *models.Socket, string, string) (string, string, []any, map[string][]string, error)); ok {
		return rf(ctx, socket, clientIP, publicKey)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *models.Socket, string, string) string); ok {
		r0 = rf(ctx, socket, clientIP, publicKey)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, *models.Socket, string, string) string); ok {
		r1 = rf(ctx, socket, clientIP, publicKey)
	} else {
		r1 = ret.Get(1).(string)
	}

	if rf, ok := ret.Get(2).(func(context.Context, *models.Socket, string, string) []any); ok {
		r2 = rf(ctx, socket, clientIP, publicKey)
	} else {
		if ret.Get(2) != nil {
			r2 = ret.Get(2).([]any)
		}
	...
	if rf, ok := ret.Get(3).(func(context.Context, *models.Socket, string, string) map[string][]string); ok {
		r3 = rf(ctx, socket, clientIP, publicKey)
	} else {
		if ret.Get(3) != nil {
	...
	if rf, ok := ret.Get(4).(func(context.Context, *models.Socket, string, string) error); ok {
		r4 = rf(ctx, socket, clientIP, publicKey)
	} else {
		r4 = ret.Error(4)
	}
...
// API_EvaluatePeer_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'EvaluatePeer'
type API_EvaluatePeer_Call struct {
	*mock.Call
}

// EvaluatePeer is a helper method to define mock.On call
//   - ctx context.Context
//   - socket *models.Socket
//   - clientIP string
//   - publicKey string
func (_e *API_Expecter) EvaluatePeer(ctx interface{}, socket interface{}, clientIP interface{}, publicKey interface{}) *API_EvaluatePeer_Call {
	return &API_EvaluatePeer_Call{Call: _e.mock.On("EvaluatePeer", ctx, socket, clientIP, publicKey)}
}

func (_c *API_EvaluatePeer_Call) Run(run func(ctx context.Context, socket *models.Socket, clientIP string, publicKey string)) *API_EvaluatePeer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*models.Socket), args[2].(string), args[3].(string))
	})
	return _c
}

func (_c *API_EvaluatePeer_Call) Return(email string, entityUUID string, allowedActions []any, info map[string][]string, err error) *API_EvaluatePeer_Call {
	_c.Call.Return(email, entityUUID, allowedActions, info, err)
	return _c
}

func (_c *API_EvaluatePeer_Call) RunAndReturn(run func(context.Context, *models.Socket, string, string) (string, string, []any, map[string][]string, error)) *API_EvaluatePeer_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *API) GetOrganizationInfo(ctx context.Context) (*models.Organization, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetOrganizationInfo")
	}
...
func (_m *API) GetPoliciesBySocketID(socketID string) ([]models.Policy, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetPoliciesBySocketID")
	}
...
func (_m *API) GetSockets(ctx context.Context) ([]models.Socket, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetSockets")
	}
...
func (_m *API) GetTunnel(ctx context.Context, socketID string, tunnelID string) (*models.Tunnel, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetTunnel")
	}
...
func (_m *API) ServerOrgCertificate(ctx context.Context, name string, csr []byte) ([]byte, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ServerOrgCertificate")
	}
...
func (_m *API) SignSSHKey(ctx context.Context, socketID string, key []byte) (string, string, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for SignSSHKey")
	}
...
func (_m *API) SignSshOrgCertificate(ctx context.Context, socketID string, sessionID string, userEmail string, ticket []byte, publicKey []byte) ([]byte, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for SignSshOrgCertificate")
	}
...
// UploadRecording provides a mock function with given fields: content, socketID, sessionKey, recordingID, recordingType
func (_m *API) UploadRecording(content []byte, socketID string, sessionKey string, recordingID string, recordingType string) error {
	ret := _m.Called(content, socketID, sessionKey, recordingID, recordingType)

	if len(ret) == 0 {
		panic("no return value specified for UploadRecording")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func([]byte, string, string, string, string) error); ok {
		r0 = rf(content, socketID, sessionKey, recordingID, recordingType)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *API_Expecter) UploadRecording(content interface{}, socketID interface{}, sessionKey interface{}, recordingID interface{}, recordingType interface{}) *API_UploadRecording_Call {
	return &API_UploadRecording_Call{Call: _e.mock.On("UploadRecording", content, socketID, sessionKey, recordingID, recordingType)}
}

func (_c *API_UploadRecording_Call) Run(run func(content []byte, socketID string, sessionKey string, recordingID string, recordingType string)) *API_UploadRecording_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *API_UploadRecording_Call) RunAndReturn(run func([]byte, string, string, string, string) error) *API_UploadRecording_Call {
	_c.Call.Return(run)
	return _c
}
