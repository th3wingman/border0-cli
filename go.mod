...
require (
	...
	github.com/borderzero/border0-go v1.4.62
	github.com/borderzero/border0-proto v1.0.69
	github.com/borderzero/discovery v0.1.37
	github.com/borderzero/turtle v1.2.0
	github.com/borderzero/water v0.0.1
	github.com/borderzero/wintundll-downloader-go v0.0.4
	github.com/borderzero/wireguard-go v0.0.3
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/ec2instanceconnect v1.26.1
	...
	github.com/pingcap/tidb/pkg/parser v0.0.0-20240925105419-a159c49274c7 // indirect
	...
	gvisor.dev/gvisor v0.0.0-20241004023350-b89f53b2ceb0
...
replace (
	github.com/microsoft/go-mssqldb => github.com/borderzero/go-mssqldb v1.6.3 // custom fork
	github.com/twinj/uuid => github.com/twinj/uuid v0.0.0-20151029044442-89173bcdda19 // see  https://github.com/aws/session-manager-plugin/issues/73
	gvisor.dev/gvisor => gvisor.dev/gvisor v0.0.0-20240320082913-9a678ae3d5ca // waiting for https://github.com/WireGuard/wireguard-go/pull/109 or another fix that solves the isNil issue.
)
